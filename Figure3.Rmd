...
pacman::p_load(ggplot2, DESeq2, dplyr, ggrepel, ggvenn, nichenetr, 
               openxlsx, pheatmap, reshape2, RColorBrewer, clusterProfiler,
               enrichplot)
...
```{r supervised}
resultsNames(dds)
results <- lfcShrink(dds, coef="Age_Group_old_vs_adult", type="normal")
